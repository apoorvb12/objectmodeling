...
public class PlaySongDto {
    ...
    public PlaySongDto(String playListId, String playListName, List<Song> songs) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        PlaySongDto other = (PlaySongDto) obj;
        if (playListId == null) {
    ...
    public String toString() {
        return "PlaySongDto [playListId=" + playListId + ", playListName=" + playListName
                + ", songs=" + songs + "]";
    }
